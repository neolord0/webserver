...
public class PEMFile {
    ...
    public PEMFile(String filename, String password, String keyAlgorithm)
        ...
        try (InputStream inputStream = ConfigFileLoader.getFileInputStream(filename)) {
    ...
    private class Part {
        ...
        public PrivateKey toPrivateKey(String password, String keyAlgorithm) throws GeneralSecurityException, IOException {
            ...
            InvalidKeyException exception = new InvalidKeyException("Unable to parse the key from " + filename);
