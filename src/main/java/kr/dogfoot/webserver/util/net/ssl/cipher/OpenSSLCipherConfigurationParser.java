...
package kr.dogfoot.webserver.util.net.ssl.cipher;
...
/**
 * Class in charge with parsing openSSL expressions to define a list of cipher.
 */
public class OpenSSLCipherConfigurationParser {

    private static final String SEPARATOR = ":|,| ";
    /**
     * If ! is used then the cipher are permanently deleted from the list. The cipher deleted can never reappear in the list
     * even if they are explicitly stated.
     */
    private static final String EXCLUDE = "!";
    /**
     * If - is used then the cipher are deleted from the list, but some or all of the cipher can be added again by later
     * options.
     */
    private static final String DELETE = "-";
    /**
     * If + is used then the cipher are moved to the end of the list. This option doesn't add any new cipher it just moves
    ...
    /**
     * All cipher by their openssl alias name.
     */
    private static final Map<String, List<Cipher>> aliases = new LinkedHashMap<>();
    /**
     * the 'NULL' cipher that is those offering no encryption. Because these offer no encryption at all and are a security risk
    ...
    static LinkedHashSet<Cipher> strengthSort(final LinkedHashSet<Cipher> ciphers) {
        /*
         * This routine sorts the cipher with descending strength. The sorting
    ...
    static LinkedHashSet<Cipher> defaultSort(final LinkedHashSet<Cipher> ciphers) {
        ...
        /* Now arrange all cipher by preference: */
        ...
        /* Move anonymous cipher to the end.  Usually, these will remain disabled.
         * (For applications that allow them, they aren't too bad, but we prefer
         * authenticated cipher.) */
        moveToEnd(result, filterByAuthentication(result, Collections.singleton(Authentication.aNULL)));

        /* Move cipher without forward secrecy to the end */
    ...
    public static List<String> convertForJSSE(Collection<Cipher> ciphers) {
        ...
        Message.debug("Ciphers used:" + displayResult(ciphers, true, ","));
        return result;
    }
     ...
     * @return the corresponding list of cipher.
     */
