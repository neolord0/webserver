 ...
 * >SSL Labs tool - list of cipher</a>
...
public enum Cipher {
     ...
     * Neither OpenSSL nor Java implement these cipher and the IDs used
     * overlap partially with the IDs used by the Kerberos cipher
    // Cipher 1C
     ...
     */
    /* The Kerberos cipher. OpenSSL doesn't support these. Java does but they
    ...
    /* Experimental (and now expired) TLSv1 versions of SSLv3 cipher.
     ...
     * The cipher are not listed in the IANA registry. */
    /*
    // Cipher 80
     ...
     *
     * No other cipher defined until 0xC001 below
     */
