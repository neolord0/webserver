...
public class ReplyMaker {
    ...
    private static Reply _500CannotConnectWAS;
    private static Reply _500DisconnectWAS;
    private static Reply _500CannotConnectWS;
    private static Reply _500DisconnectWS;
    private static Reply _500TooManyFileOpen;
    private static Reply _417ExpectationFail;
    ...
    /*
    public Reply new_406NotAcceptable(byte[] body) {
        Reply reply = new Reply().code(ReplyCode.Code406);
        addHeader_Date(reply);
        addHeader_Server(reply);
        // DefaultMessageBody.make(reply, body);
        return reply;
    }
     */
